...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\shash\PycharmProjects\FinDataAnalyzer\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\shash\PycharmProjects\FinDataAnalyzer\venv\Scripts\deactivate.nu'
